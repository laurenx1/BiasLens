...
def add_student(conn):
    """
    Adds a new student to the database by calling the `sp_add_student` stored procedure.
    ...
    cursor = conn.cursor()
    try:
        cursor.callproc('sp_add_student', (uid, username, email, password, name, age, major, house, grad_year))
        conn.commit()
